...
### Added
- name every newsletter form for analytics form_submit tracking
...
### Fixed
- reject scanner-residue payloads sanitize_email() launders into valid addresses
...
### Changed
- align newsletter WP Error contracts

### Fixed
- stamp Turnstile-verified newsletter signups as human
- handle newsletter failure envelopes
